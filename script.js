...
const blockRateSelect =
    document.getElementById("blockRate");

const fromStageSelect =
    document.getElementById("fromStage");

const toStageSelect =
    document.getElementById("toStage");
...
const totalBlocksEl =
    document.getElementById("totalBlocks");

const miningCreditsEl =
    document.getElementById("miningCredits");

const bossCreditsEl =
    document.getElementById("bossCredits");

const totalCreditsEl =
...
const toggleBreakdownButton =
    document.getElementById("toggleBreakdown");
...
function selectedItemEntries(
    ...
    for (
        ...
        /*
            Boss data only has a Pickaxe
            tool cost.

            Axe and Shovel use that same
            boss tool cost.
        */
...
function calculate() {
    ...
    /*
        Current Stage is already owned,
        so do NOT count it.

        Goal Stage IS counted.
    */
    ...
    if (
        ...
        header = `
            ...
            >
                ...
                had none of your selected gear,
    ...
    if (
        ...
        breakdownEl.innerHTML = `
            <div class="stage">
                ...
                <div class="stage-type">
                    Your Current Stage and
                    Goal Stage are the same.
                </div>
